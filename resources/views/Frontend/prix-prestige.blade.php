...
@section('title', 'Formule prestige')
...
@section('content')
    ...
    <section id="content">
        <div class="container">
            <div class="center">
                <h2>Formule PRESTIGE</h2>
                <p class="lead">Cette configuration est prévue pour une animation Disc-jockey, jusqu’à 300 convives et coûte en moyenne : 655,99 € HTVA</p>
            </div>
            <div class="row">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="tab2">
                                        ...
                                        <ul>
                                            ...
                                            <li>6 HP TOP AudioFocus</li>
                                        </ul>
                                    </div>

                                    <div class="tab-pane fade" id="tab3">
                                        <p>Le Light Show sera installé sur un pont triangulaire en aluminium soudé de 40/40/40 et d'une longueur de : 9 ou 12 mètres et posé sur 2 pieds à treuil WORK LW 255 R agréés par AIV VINCOTTE.
                                        ...
                                        <ul>
                                            ...
                                            <li>1 araignée de 10 PAR 36 avec gélatines de couleur</li>
                                            <li>2 scans WILD BLAZE</li>
                                            <li>2 scans THOMAHAWK</li>
                                            <li>4 effets SMART BEAM</li>
                                            <li>4 effets SMART MOON</li>
                                    ...
                                    <div class="tab-pane fade" id="tab4">
                                        <p>La hauteur sous plafond pour l’installation du Light Show sur le pont doit être d’au moins 5,5 mètres.</p>
                                        <p>
                                    ...
                                    <div class="tab-pane fade" id="tab5">
                                        ...
                                        <p>
                                            Un supplément de 34,70 €/heure HTVA pour le Disc-jockey et de 28,50 €/heure par technicien est à prévoir et sera payable anticipativement à l’heure commencée de plus de 10 minutes.
                                        </p>
